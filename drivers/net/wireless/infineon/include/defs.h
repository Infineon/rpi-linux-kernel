...
#define IFX_CNTRY_BUF_SZ	4	/* Country string is 3 bytes + NUL */

#define IFX_SET_CHANNEL	30
#define IFX_SET_SRL		32
#define IFX_SET_LRL		34
#define IFX_SET_BCNPRD		76

#define IFX_GET_CURR_RATESET	114	/* current rateset */
#define IFX_GET_PHYLIST	180
...
/* band types */
#define	IFX_BAND_AUTO		0	/* auto-select */
#define	IFX_BAND_5G		1	/* 5 Ghz */
#define	IFX_BAND_2G		2	/* 2.4 Ghz */
#define	IFX_BAND_ALL		3	/* all bands */

/* Debug levels */
#define IFX_DL_INFO		0x00000001
#define IFX_DL_MAC80211	0x00000002
#define IFX_DL_RX		0x00000004
#define IFX_DL_TX		0x00000008
#define IFX_DL_INT		0x00000010
#define IFX_DL_DMA		0x00000020
#define IFX_DL_HT		0x00000040
