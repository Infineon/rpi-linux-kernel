...
static const struct ifxf_dmi_data acepc_t8_data = {
	CY_CC_4345_CHIP_ID, 6, "acepc-t8"
};
 ...
 */
static const struct ifxf_dmi_data chuwi_hi8_pro_data = {
	CY_CC_43430_CHIP_ID, 0, "ilife-S806"
};

static const struct ifxf_dmi_data gpd_win_pocket_data = {
	CY_CC_4356_CHIP_ID, 2, "gpd-win-pocket"
};

static const struct ifxf_dmi_data jumper_ezpad_mini3_data = {
	CY_CC_43430_CHIP_ID, 0, "jumper-ezpad-mini3"
};

static const struct ifxf_dmi_data meegopad_t08_data = {
	CY_CC_43340_CHIP_ID, 2, "meegopad-t08"
};

static const struct ifxf_dmi_data pov_tab_p1006w_data = {
	CY_CC_43340_CHIP_ID, 2, "pov-tab-p1006w-data"
};
...
void ifxf_dmi_probe(struct ifxf_mp_device *settings, u32 chip, u32 chiprev)
{
	...
	const struct ifxf_dmi_data *data;
