 ...
 */
#if !defined(IFXF_TRACEPOINT_H_) || defined(TRACE_HEADER_MULTI_READ)
#define IFXF_TRACEPOINT_H_
...
#endif /* CONFIG_IFX_TRACING */

#undef TRACE_SYSTEM
#define TRACE_SYSTEM	ifxfmac

#define MAX_MSG_LEN		100

TRACE_EVENT(ifxf_err,
